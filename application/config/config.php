...
|
*/
$config['base_url'] = isset($_ENV['BASE_URL']) ? $_ENV['BASE_URL'] : 'http://localhost/';
...
|
*/
$config['log_threshold'] = 4; // Ensure this is set to 4 to log all messages
...
|
*/
$config['log_file_extension'] = ''; // Default log file extension
...
*/
$config['log_file_permissions'] = 0644; // Default log file permissions
...
|
*/
$config['log_date_format'] = 'Y-m-d H:i:s'; // Default log date format
...
|--------------------------------------------------------------------------
|
| The maximum number of log files to keep. 0 means unlimited.
|
*/
$config['log_max_files'] = 0; // Default log max files
